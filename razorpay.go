...
// func (r *RazorPay) GetPaymentLink(order NewOrder) (*Order, error) {
// 
// }
// 
// func (r *RazorPay) SendPaymentLink(order NewOrder) (*Order, error) {
// 
// }
// 
// func (r *RazorPay) CancelPaymentLink(order NewOrder) (*Order, error) {
// 
// }
